...
class Title extends Component<IProps> {
	...
	handlers = {
		goGithub: () => {
			window.open('https://www.quinkpost.com');
		},
		goDocs: () => {
			window.open('https://www.quinkpost.com');
		},
	...
	render() {
		...
		return (
			<Flex
				...
				alignItems="center"
			>
				<Flex style={{ marginLeft: 8 ,marginRight:24, width: "max-content" }} 
				// flex="0 1 auto"
				>
					<span style={{ color: '#fff', fontSize: 16, fontWeight: 500 }}>Quink Post Design Editor</span>
